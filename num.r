...
simular <- function() {
  ...
  # repeticiones <- corridas_simulacion # asignado al inicio
  repeticiones = 10 # asignado arriba
  ...
  for( i in 1:repeticiones ){ # fórmula notable
      varianza_muestral = varianza_muestral + (t_msj_destino[i]-media_muestral)^2
  }
